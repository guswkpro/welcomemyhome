        ...
        function (nextCallback) {
            ...
            async.whilst(function () {
                ...
                if (error) {
                    ...
                    var date = new Date(estimatedata[0].estimate_post_date);
                    estimatedata[0].estimate_post_date = date.toFormat('YYYY-MM-DD HH24:MI:SS');
        ...
        function (nextCallback) {
            ...
            async.whilst(function () {
                ...
                fs.readFile(estimatedata[count].estimate_picture_path[count], function (error, data) {
                    encodedimage.push(new Buffer(data).toString('base64'));
                    var date = new Date(estimatedata[count].estimate_post_date);
                    estimatedata[count].estimate_post_date = date.toFormat('YYYY-MM-DD HH24:MI:SS');
