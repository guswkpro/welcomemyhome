...
exports.addestimateanswer = function (estimateanswer, callback) {
    client.query('INSERT INTO stweb.stweb_estimates (estimate_picture_path, estimate_content, estimate_date,  estimate_idx, user_idx) VALUES (?, ?, ?, ?, ?)', [estimateanswer.answer_picture_path, estimateanswer.answer_content, estimateanswer.answer_date, estimateanswer.estimate_idx, estimateanswer.user_idx], function (error) {
        callback(error);
    });
};
