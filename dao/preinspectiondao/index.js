...
exports.addpreinspectionmodal = function (pin, callback) {
        client.query('INSERT INTO stweb.stweb_preinspections (preinspection_idx, pin_picture_path, pin_type, pin_X, pin_Y, pin_content) VALUES (?, ?, ?, ?, ?, ?)',  [Number(pin.preinspection_idx), pin.pin_picture_path, pin.pin_type, Number(pin.pin_X), Number(pin.pin_Y), pin.pin_content], function(error) {
                callback(error);
        });
}